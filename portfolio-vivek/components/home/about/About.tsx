        ...
        <div>
          <Reveal>
            <p className={`${styles.aboutText} ${styles.highlightFirstLetter}`}>
              Howdy! I&apos;m Vivek Kumar Khatana, and I&apos;m a Bachelor of Science in Information Technology graduate.
              <br/><br/>
          ...
          <Reveal>
            <p className={styles.aboutText}>
              ...
              I&apos;ve also worked with backend technologies like Node.js, Firebase, MongoDB and Python , allowing me to build full-stack applications.
            </p>
          </Reveal>
          <Reveal>
            <p className={styles.aboutText}>
