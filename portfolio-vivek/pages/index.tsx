...
export default function home() {
  return (
    <>
      <Head>
        <title>Vivek Khatana | Frontend Developer</title>
        <link rel="shortcut icon" href="/favicon.png" />
        <meta name="description" content="Vivek Kumar Khatana | Frontend Developer" />
        ...
        <meta property="og:title" content="Vivek Kumar Khatana | Frontend Developer" />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://deverajc.com/" />
        <meta property="og:image" content="https://deverajc.com/screenshot.png" />
        <meta property="og:description" content="Hey! I'm Vivek Kumar Khatana, and I'm a Bachelor of Science in Information Technology graduate." />

        <meta name="twitter:card" content="summary"/>
        <meta name="twitter:site" content="@jc_devz"/>
        <meta name="twitter:title" content="Vivek Kumar Khatana | Frontend Developer"/>
        <meta name="twitter:description" content="Hey! I'm Vivek Kumar Khatana, and I'm a Bachelor of Science in Information Technology graduate."/>
